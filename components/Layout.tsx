...
const Layout: React.FC<LayoutProps> = ({ activeTab, setActiveTab, children }) => {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-slate-50">
      <header className="flex-none px-6 py-4 bg-indigo-600 text-white flex justify-between items-center shadow-lg z-50">
        ...
        <div className="flex space-x-2">
           <button className="p-2 hover:bg-white/10 rounded-full transition-colors relative">
             ...
             <span className="absolute top-1 right-1 w-2 h-2 bg-amber-400 rounded-full border-2 border-indigo-600"></span>
           </button>
        </div>
      </header>
