...
const Layout: React.FC<LayoutProps> = ({ activeTab, setActiveTab, children }) => {
  const tabs = [
    { id: AppTab.AI_ASSISTANT, label: '智能助手', icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
    )},
    { id: AppTab.NEWS, label: '行业资讯', icon: (
    ...
    { id: AppTab.COMPONENT_SEARCH, label: '元器件', icon: (
    ...
    { id: AppTab.TOOLS, label: '工程工具', icon: (
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-slate-50">
      <header className="flex-none px-4 py-3 bg-indigo-600 text-white flex justify-between items-center shadow-lg">
        <h1 className="text-xl font-bold tracking-tight">EELIB 硬件智库</h1>
